...
func load_data() -> void:
	...
	while qr.next_row():
		...
		# You can now:
		print("id: " + str(qr.get_next_cell_int()))
		print("data_varchar: " + str(qr.get_next_cell()))
		print("data_text: " + str(qr.get_next_cell()))
		print("data_int: " + str(qr.get_next_cell_int()))
		print("data_double: " + str(qr.get_next_cell_double()))
